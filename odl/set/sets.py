...
class Set(with_metaclass(ABCMeta, object)):
    ...
    **Returns:**
    ...
    @property
    def examples(self):
        """Return a generator creating name-value pairs of set elements.

        Can return a finite set of examples or an infinite set.

        This method is mainly intended for diagnostics and should create
        a finite or infinite collection of elements.
        ...
        Returns
        -------
        example_gen : iterable
            Sequence or generator that returns name-value pairs for
...
class Strings(Set):
    ...
    def __init__(self, length):
        ...
        ----------
        length : positive int
            The fixed length of the strings in this set
        """
    ...
    def contains_all(self, other):
        """Return True if ``other`` contains only strings of correct length."""
...
class Field(Set):
    ...
    def field(self):
        ...
        Notes
        -----
        This is a hack for to make fields to work via duck-typing
        with `LinearSpace`'s.
        """
        return self
...
class CartesianProduct(Set):
    ...
    """The Cartesian product of a finite number of sets.
